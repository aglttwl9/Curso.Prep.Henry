...
function esEntero(numero) {
  ...
  // Tu código:
  if(numero === Math.floor(numero)){return true} return false //tambien puede hacerse 'if(numero - Math.floor(numero) === 0){return true} return false'
}
...
function fizzBuzz(numero) {
  ...
  if(numero % 3 === 0 && numero % 5 === 0){return 'fizzbuzz'}//las condiciones '||' deben ir primeras y luego las condiciones '&&', si no, las toma como error
...
function operadoresLogicos(num1, num2, num3) {
  ...
  return false
}//las condiciones '||' deben ir primeras y luego las condiciones '&&', si no, las toma como error
